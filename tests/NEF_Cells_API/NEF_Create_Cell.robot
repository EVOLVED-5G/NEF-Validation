*** Settings ***
Documentation   This test file contains the test cases of the create cell endpoint for NEF Emulator API.
...
*** Test Cases ***
Create valid cell valid token
    [Tags]    create_valid_cell_valid_token
...
Create invalid cell valid token
    [Tags]    create_invalid_cell_valid_token
    ${token}=    Get Access Token    %{NEF_URL}    %{ADMIN_USER}    %{ADMIN_PASS}
